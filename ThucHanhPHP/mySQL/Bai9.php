...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-4">
        <h4 class="mt-4 ml-5 mb-4 text-center">- TÌM KIẾM THÔNG TIN SỮA -</h4>
        <!-- Search form -->
            ...
            <tbody>
                <?php 
                    while($row = mysqli_fetch_array($result)) 
                        echo'
                        <th colspan="2" class="text-center bg-dark text-light">'.$row['Ten_sua'].'</th>
                        <tr>
        ...
        <a href="../Index.php" class="btn btn-danger mx-auto mb-5">Trở Về</a>
    </div>
