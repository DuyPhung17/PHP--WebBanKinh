...
<html lang="en">
  ...
  <body>
    ...
    <h2 class="text-center mt-4 mb-4">- THÔNG TIN CÁC SẢN PHẨM -</h2>
    ...
    <div class="row">
        <?php 
            ...
            <div class="col">
            <p>
                <a href="Bai7-detail.php?id='.$row['Ma_sua'].'">'.$row['Ten_sua'].'</a>
                <br>'.$row['Trong_luong'].'gr - '.number_format($row['Don_gia']).' VND</p>
                <img height="100px" src="img/'.$row['Hinh'].'"/>
            </div>
            ';
        ?>
...
<!--Phan trang-->
<ul class="pagination mx-auto mt-4" style="width: 40%">
  <?php 
      if(isset($_GET['pg']))
      {
          //Gan nut truoc
      ...
      else header('location: Bai7.php?pg=1');
  ?>
</ul>
