...
<html lang="en">
  ...
  <body>
    ...
    <h4 class=" text-center mb-4">- Bạn đã nhập thành công! Dưới đây là thông tin đã nhập -</h4>
    ...
    <form action="" method="" style="width:50%;margin-left:20%" name="TinhDiem">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
            <a href="javascript:window.history.back(-1);" class="btn btn-danger">Trở Về</a>
            </div>
        </div>
