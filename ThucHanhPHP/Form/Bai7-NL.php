...
<html lang="en">
  ...
  <body>
    ...
    <h3 class=" text-center mb-4">BÀI 7: PHÉP TÍNH TRÊN HAI SỐ (MỞ RỘNG)</h3>

    <form action="Bai7-KQ.php" method="post" style="width:50%;margin-left:25%"  name="TinhDiem">
        ...
        <div class="form-group row">
          ...
          <input type="text" name="So1" class="form-control col-sm-8" value="<?php if(isset($So1)) echo $So1 ?>">
        </div>
        
        <div class="form-group row">
          <label class="col-sm-4 col-form-label">Số thứ 2: </label>
          <input type="text" name="So2" class="form-control col-sm-8" value="<?php if(isset($So2)) echo $So2 ?>">
        </div>
        ...
        <label class="col-sm-4 col-form-label"></label>
          ...
          <input class="btn btn-success" type="submit" value="Tính Toán" name="submit">
