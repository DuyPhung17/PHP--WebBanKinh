...
<html lang="en">
  ...
  <body>
    ...
    <h3 class="text-center mt-4">Bài 6: SẮP XẾP MẢNG</h3>
    <div class="container mt-4" style="margin-left: 27%;">
        <form action="" method="post">
            ...
            <button type="submit" name="submit" class="btn btn-primary">Sắp xếp</button>
            <button class="btn btn-secondary" type="reset">Đặt lại</button>

            <div class="form-group w-50 mt-3">
                <p class="text-primary">Sau khi sắp xếp: </p>
