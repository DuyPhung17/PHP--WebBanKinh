...
<html lang="en">
  ...
  <body>
    ...
    <h3 class="text-center mt-4">Bài 7: TÍNH NĂM ÂM LỊCH</h3>
    <div class="container mt-2 mb-2" style="margin-left: 27%;">
        <form action="" method="post">
            ...
            <button type="submit" name="submit" class="btn btn-primary mb-3">Chuyển </button>
            <button class="btn btn-secondary mb-3" type="reset">Đặt lại</button>
        ...
        <a href="../../Index.php"  class="btn btn-danger mt-2">Trở Về</a>
    </div>
  </body>
</html>