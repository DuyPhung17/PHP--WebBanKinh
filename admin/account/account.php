    ...
    <div class="top">
        ...
        <form action="" method="get">
            ...
            <div class="input-group">
                <input type="text" name="s" class="form-control" placeholder="Tìm kiếm tài khoản" value="<?php if(isset($s)) echo $s ?>">
        ...
        <?php 
            if(!empty($s))
            {
                ...
                {   
                    ...
                    else echo '<li class="page-item"><a class="page-link" href="?page=a&pg='.$i.'&s='.$s.'&submit=">'.$i.'</a></li>';
                }
                //Gan nut sau
