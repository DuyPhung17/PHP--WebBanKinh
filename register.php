    ...
    <form action="" method="post" enctype="multipart/form-data" style="width:50%;margin-left:20%">
       ...
       <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <input type="text" name="password" class="form-control col-sm-8" value="<?php if(isset($password)) echo $password ?>">
        </div>
        <?php 
        ...
        <div class="form-group row">
          ...
          <input type="text" name="passwordRT" class="form-control col-sm-8" value="<?php if(isset($passwordRT)) echo $passwordRT ?>">
        </div>
        <?php 
