<?php 
  ...
  if(isset($_POST['submit']))
  {
    ...
    {
      $sql = 'INSERT INTO account(name,username,password,phone,address,image) 
                VALUES("'.$name.'","'.$username.'","'.$password.'","'.$phone.'","'.$address.'","'.$img.'")';
...
<div class="mt-4">
    ...
    <form action="" method="post" enctype="multipart/form-data" style="width:50%;margin-left:20%">
       ...
       <div class="form-group row">
          ...
          <input type="text" name="username" class="form-control col-sm-8" value="<?php if(isset($username)) echo $username ?>">
        </div>
        <?php 
        ...
        <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <p class="text-secondary col-sm-8">Chưa chọn ảnh đại diện! Ảnh đại diện sẽ thiêt lập theo mặc định</p>
            </div>
